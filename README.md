...
- Note on compiler compatibility. Tested on g++ (GCC) 13.2.0. A compatibility fix was introduced for newer GCC versions (See commit history for implementation details).
